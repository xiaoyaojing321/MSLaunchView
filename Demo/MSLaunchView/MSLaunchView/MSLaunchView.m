...
+(instancetype)launchWithImages:(NSArray <NSString *>*)images{
    return [[MSLaunchView alloc] initWithVideoframe:CGRectZero guideFrame:CGRectZero images:images gImage:nil sbName:nil videoUrl:nil isScrollOut:NO];
}
...
//        }
        ...
        NSString *path = [[NSBundle mainBundle] pathForResource:self.dataImages[i] ofType:@"jpg"];
...
-(UIButton *)guideButton{
    return MS_LAZY(_guideButton, ({
        ...
        guideButton.frame = CGRectMake(40.0, MSScreenH - 140, MSScreenW - 80, 100);
        [guideButton setBackgroundColor:[UIColor clearColor]];
